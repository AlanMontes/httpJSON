...
public class MainActivity extends AppCompatActivity {
    private String url =
            "https://alanmontessilva.000webhostapp.com/consultar_gramineas.php";
                    ...
                    public void onResponse(JSONArray response) {
                        for (int i = 0; i < response.length(); i++){
                            try {
                                ...
                                cultivo.setIdgraminea(jsonObject.getInt("id"));
                                cultivo.setNombreComun(jsonObject.getString("nombre_comun"));
                                cultivo.setNombreCientifico(jsonObject.getString("nombre_cientifico"));
